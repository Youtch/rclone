...
import (
	...
	"github.com/Youtch/rclone/backend/crypt"
	_ "github.com/Youtch/rclone/backend/drive" // for integration tests
	_ "github.com/Youtch/rclone/backend/local"
	_ "github.com/Youtch/rclone/backend/swift" // for integration tests
