...
If it is a big feature, then [make an issue](https://github.com/Youtch/rclone/issues) first so it can be discussed.

To prepare your pull request first press the fork button on [rclone's GitHub
page](https://github.com/Youtch/rclone).
...
Next open your terminal, change directory to your preferred folder and initialise your local rclone project:
    ...
    git clone https://github.com/Youtch/rclone.git
    cd rclone
...
To base your changes on the latest version of the [rclone master](https://github.com/Youtch/rclone/tree/master) (upstream):
...
rclone currently uses [GitHub Actions](https://github.com/Youtch/rclone/actions) to build and test the project, which should be automatically available for your fork too from the `Actions` tab in your repository.
...
project root:
    ...
    go install github.com/Youtch/rclone/fstest/test_all
...
- HTTP based remotes are easiest to maintain if they use rclone's [lib/rest](https://pkg.go.dev/github.com/Youtch/rclone/lib/rest) module, but if there is a really good Go SDK from the provider then use that instead.
- Try to implement as many optional methods as possible as it makes the remote more usable.
- Use [lib/encoder](https://pkg.go.dev/github.com/Youtch/rclone/lib/encoder) to make sure we can encode any path name and `rclone info` to help determine the encodings needed
...
- **Do** use [lib/rest](https://pkg.go.dev/github.com/Youtch/rclone/lib/rest) if you are implementing a REST like backend and parsing XML/JSON in the backend.
- **Do** use rclone's Client or Transport from [fs/fshttp](https://pkg.go.dev/github.com/Youtch/rclone/fs/fshttp) if your backend is HTTP based - this adds features like `--dump bodies`, `--tpslimit`, `--user-agent` without you having to code anything!
...
For an example of adding an s3 provider see [eb3082a1](https://github.com/Youtch/rclone/commit/eb3082a1ebdb76d5625f14cedec3f5154a5e7b10).
...
[Go reference](https://godoc.org/github.com/Youtch/rclone/lib/plugin)
